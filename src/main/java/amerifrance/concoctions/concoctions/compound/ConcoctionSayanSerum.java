...
public class ConcoctionSayanSerum extends Concoction {
    ...
    public Concoction[] parents = {ModConcoctions.strength, ModConcoctions.speed, ModConcoctions.resistance, ModConcoctions.regeneration, ModConcoctions.jumpBoost, ModConcoctions.slowness, ModConcoctions.mineSlow, ModConcoctions.hunger};
