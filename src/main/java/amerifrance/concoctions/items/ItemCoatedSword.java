...
public class ItemCoatedSword extends ItemSword {

    public IIcon blade;

    public ItemCoatedSword() {
        super(ItemsRegistry.COATED_MATERIAL);
        setCreativeTab(CreativeConcoctions.tabConcoction);
        setUnlocalizedName(ModInformation.ID + ".coated.sword");
        setHasSubtypes(true);
    }
    ...
    public void registerIcons(IIconRegister ir) {
        this.itemIcon = ir.registerIcon(ModInformation.TEXLOC + "coated_sword_handle");
        this.blade = ir.registerIcon(ModInformation.TEXLOC + "coated_sword_blade");
    }
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (getConcoction(stack) != null)
            ConcoctionsHelper.addConcoction(target, getConcoction(stack), getLevel(stack), getDuration(stack));
        return true;
    }
